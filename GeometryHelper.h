...
public:
	...
	static void CreateCube(Geometry<VertexColorData>& geometry, Color color);
	...
	static void CreateGrid(shared_ptr<Geometry<VertexTextureData>> geometry, uint32 sizeX, uint32 sizeZ, uint32 divideBy);
