...
public:
	virtual bool	UpdateVertexList(KNode* pNode); // ���� �Լ�
	virtual HRESULT	CreateVertexBuffer(KNode* pNode); // ���� �Լ�
	virtual KNode*  CreateNode(KNode* pParent, float x, float y, float w, float h); // ���� �Լ�
public:
